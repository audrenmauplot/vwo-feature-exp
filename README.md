...
Splitly is a lightweight A/B testing and experimentation platform for product and growth teams. This repo contains a marketing
site built with Astro to promote Splitly's features, pricing and documentation.

## What this repo contains

- Marketing pages: homepage, pricing, about, contact
- Components and widgets for product marketing
- Demo content and blog (optional)
...
Update `src/config.yaml` to set your `site.name` and `site.url`, then run the dev server.
